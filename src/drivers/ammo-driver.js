...
AmmoDriver.prototype.init = function(worldConfig) {
  ...
  return new Promise(resolve => {
    AmmoModule().then(result => {
      ...
      this.debugDrawMode = worldConfig.debugDrawMode || 0 ; //GD just a guess missing AmmoDebugConstatnts was: THREE.AmmoDebugConstants.NoDebug;
      ...
      //this.physicsWorld.setForceUpdateAllAabbs(false); //GD not in ammo.js 0.0.2
